...
public class Fruquency {
    public static void main(String[] args) {
       ...
       // int count = 0;   // count the total number of occurence of each chracter from str
        for (int i = 0; i <= str.length() - 1; i++) {
            if (!nonDup.contains("" + str.charAt(i))) {  //if the character at index i is not contained in nonDup, then it will
                nonDup += str.charAt(i);
            }
        }
